...
db.execute("""INSERT INTO addresses (user_id, street, city, state, postal_code)
VALUES
...
db.execute("""SELECT users.name,users.id AS user_id, addresses.city, addresses.state, addresses.id AS addresses_id 
